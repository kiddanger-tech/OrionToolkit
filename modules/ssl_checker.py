...
def check_ssl(hostname, port=443, timeout=10):
    ...
    try:
        ...
        console.print(f"[red]Could not resolve hostname: {hostname}[/red]")
    except socket.timeout:
        console.print(f"[red]Connection timed out: {hostname}:{port}[/red]")
    except ConnectionRefusedError:
        console.print(f"[red]Connection refused: {hostname}:{port}[/red]")
