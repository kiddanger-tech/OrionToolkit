    ...
    for ext in extensions:
        ...
        try:
            ...
            if resp.status_code in (200, 201, 204):
                ...
                results.append((full_path, resp.status_code, "Auth Required" if resp.status_code == 401 else "Forbidden"))
...
def menu_dir_fuzzer():
    ...
    with Progress(
        ...
        with ThreadPoolExecutor(max_workers=threads) as executor:
            futures = {executor.submit(check_path, base_url, word, exts, timeout, False): word for word in wordlist}
